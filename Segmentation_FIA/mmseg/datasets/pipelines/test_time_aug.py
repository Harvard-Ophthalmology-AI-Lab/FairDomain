...
class MultiScaleFlipAug(object):
    ...
    def __call__(self, results):
        ...
        # print("test aug 1", self.img_scale)
        ...
        for scale in img_scale:
            for flip in flip_aug:
                for direction in self.flip_direction:
                    ...
                    # print("test aug 1", _results['img'].shape)
                    data = self.transforms(_results)
                    # print("test aug 1.5", data['img'].shape)
                    aug_data.append(data)
        # pdb.set_trace()
        # print("test aug 1", aug_data['img'][0].shape)
        ...
        # print("test aug 2", aug_data_dict['img'][0].shape)
