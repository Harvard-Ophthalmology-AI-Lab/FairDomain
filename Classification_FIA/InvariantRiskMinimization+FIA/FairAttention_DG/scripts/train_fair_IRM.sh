...
NUM_EPOCH=20
BATCH_SIZE=10
PERF_FILE=${MODEL_TYPE[$j]}_${MODALITY_TYPE}_${ATTRIBUTE_TYPE[$a]}_fairattention.csv
...
python ./scripts/train_fair_IRM.py \
		--data_dir ${DATASET_DIR}/ \
		--result_dir ${RESULT_DIR}/results_IRM_fairattention/dr_${MODALITY_TYPE}_${ATTRIBUTE_TYPE[$a]}/${MODEL_TYPE[$j]}_${MODALITY_TYPE}_lr${LR}_bz${BATCH_SIZE} \
...
# 		--result_dir ${RESULT_DIR}/results_odir/dr_${MODALITY_TYPE}_${ATTRIBUTE_TYPE[$a]}/${MODEL_TYPE[$j]}_${MODALITY_TYPE}_lr${LR}_bz${BATCH_SIZE}_oversample \
# 		--model_type ${MODEL_TYPE[$j]} \
# 		--image_size 200 \
# 		--lr ${LR} --weight-decay 0. --momentum 0.1 \
# 		--batch_size ${BATCH_SIZE} \
