...
python train.py --config_file configs/pretrain.yml MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'Fundus' \
OUTPUT_DIR './logs/pretrain/'$model'/fairdomain/Fundus' \
DATASETS.ROOT_TRAIN_DIR './data/FairDomain_Classify/oct_fundus/train/oct_train_list.txt' \
DATASETS.ROOT_TEST_DIR './data/FairDomain_Classify/oct_fundus/test/oct_test_list.txt'  \
